...
import bocongthuongNoti from './../../../icons/bocongthuong_noti.png';
import bocongthuongRegister from './../../../icons/bocongthuong_register.png';
                ...
                <ScrollView>
                    <View>
                        ...
                        <TouchableOpacity
                            ...
                            onPress={this.gotoScreen.bind(this, 'MapScreen')}
                        >
                        ...
                        <TouchableOpacity
                            style={styles.btnMenu}
                            onPress={this.gotoScreen.bind(this, 'AllBuildingScreen')}
                        >
                        ...
                        <TouchableOpacity
                            style={styles.btnMenu}
                            onPress={this.gotoScreen.bind(this, 'HomeScreen')}
                        >
                        ...
                        <TouchableOpacity
                            style={styles.btnMenu}
                            onPress={this.gotoScreen.bind(this, 'CategoryPartnerScreen')}
                        >
                        ...
                        <TouchableOpacity
                            style={styles.btnMenu}
                            onPress={this.gotoScreen.bind(this, 'QuestionScreen')}
                        >
                        ...
                        <TouchableOpacity
                            style={styles.btnMenu}
                            onPress={this.gotoScreen.bind(this, 'PrivacyScreen')}
                        >
                        ...
                        <TouchableOpacity
                            style={styles.btnMenu}
                            onPress={this.gotoScreen.bind(this, 'TestScreen')}
                        >
                            <Image source={icHistory} style={styles.iconMenu} />
                    ...
                    <View style={{ paddingTop: 10, bottom: 0 }}>
                        ...
                        <View>
                            ...
                            >
                                Phát triển bởi VTECHHOME
                            </Text>
                        </View>
                        <View>
                            <Text
                                style={{ fontSize: 12, color: '#F58319' }}
                            >
                                CÔNG TY CỔ PHẦN CÔNG NGHỆ BẤT ĐỘNG SẢN VTECHHOME
                            </Text>
                        </View>
                        <View>
                            <Text
                                style={{ fontSize: 12, color: '#053654' }}
                            >
                                Địa chỉ: Tầng 2, Tổ hợp TMDV và Căn hộ The Pride, KĐT mới An Hưng, Phường La Khê, Quận Hà Đông, TP. Hà Nội
                            </Text>
                        </View>
                        <View>
                            <Text
                        ...
                        <View>
                            <Text
                                style={{ fontSize: 12, color: '#053654' }}
                            >
                                Website: www.vtechhome.com
                            </Text>
                        </View>
                    </View>
                    <View style={styles.groupBoCongThuong}>
                        <Image
                            source={bocongthuongNoti}
                            style={{ width: width / 3.5, height: ((width / 3.5) / 243) * 92 }}
                        />
                        <Image
                            source={bocongthuongRegister}
                            style={{ width: width / 3.5, height: ((width / 3.5) / 243) * 92 }}
                        />
                    </View>
                </ScrollView>
